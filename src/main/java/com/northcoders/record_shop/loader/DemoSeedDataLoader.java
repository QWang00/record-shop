...
public class DemoSeedDataLoader {
    ...
    public CommandLineRunner demoDataLoader(AlbumRepository albumRepository) {
        return args -> {
            ...
            albumRepository.save(new Album(null, "Oasis", 1995, Album.AlbumGenres.BRITPOP, "What's the Story Morning Glory?", "https://album-images-bucket.s3.eu-west-2.amazonaws.com/What%27s+the+Story+Morning+Glory?%22.jpeg"));
